...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="inline-usage" class="anchor fw-bolder mb-3">
      <a href="#inline-usage" />
      Inline Usage
    </h1>
    <!-- end::Heading -->
    ...
    <div class="py-5">
      <div class="rounded border d-flex flex-wrap p-10">
        <span class="svg-icon svg-icon-3x me-10">
          <InlineSvg src="/media/icons/duotone/Design/Adjust.svg" />
        </span>
        <span class="svg-icon svg-icon-3x me-10">
          <InlineSvg src="/media/icons/duotone/Code/Git3.svg" />
        </span>
        <span class="svg-icon svg-icon-3x me-10">
          <InlineSvg src="/media/icons/duotone/Communication/Chat2.svg" />
        </span>
        <span class="svg-icon svg-icon-3x me-10">
        ...
        <span class="svg-icon svg-icon-3x me-10">
          <InlineSvg src="/media/icons/duotone/Tools/Tools.svg" />
        </span>
        <span class="svg-icon svg-icon-3x me-10">
