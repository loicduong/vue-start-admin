      ...
      <div class="rounded border p-10">
        <div class="d-flex flex-column">
          <li class="d-flex align-items-center py-2">
            <span class="bullet bullet-vertical me-5" /> Item 1
          </li>
          <li class="d-flex align-items-center py-2">
            <span class="bullet bullet-vertical bg-danger me-5" /> Item 2
          </li>
          <li class="d-flex align-items-center py-2">
            <span class="bullet bullet-vertical bg-success me-5" /> Item 3
          </li>
          <li class="d-flex align-items-center py-2">
            <span class="bullet bullet-vertical bg-info me-5" /> Item 4
          </li>
          <li class="d-flex align-items-center py-2">
            <span class="bullet bullet-vertical bg-primary me-5" /> Item 5
          </li>
        </div>
      </div>
    </div>
