...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="cell-spacing" class="anchor fw-bolder mb-5">
      <a href="#cell-spacing" />
      Row Border Styling
    </h1>
    <!-- end::Heading -->
    ...
    <!-- begin::Block -->
    <div class="py-5">
      Use <code>.table-row-bordered</code>&nbsp; or
      <code>.table-row-dashed</code>&nbsp; class to set border bottom style row
      cells. To change the row border color
