...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="responsive-table" class="anchor fw-bolder mb-5">
    ...
    <!-- begin::Block -->
    <div class="py-5">
      Enable a table with fixed cell widths and responsive modes by referring to
      the official
      <a href="https://getbootstrap.com/docs/5.0/content/tables/" class="fw-bolder me-1">Bootstrap Tables</a>
      documentation.
    </div>
    <!-- end::Block -->
