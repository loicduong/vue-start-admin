...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="striped-rounded-bordered" class="anchor fw-bolder mb-5">
      <a href="#cell-spacing" />
    ...
    <!-- begin::Block -->
    <div class="py-5">
      Use <code>.border</code>&nbsp; and <code>.table-striped</code>&nbsp; to
      set bordered table with striped rows and make it rounded with
