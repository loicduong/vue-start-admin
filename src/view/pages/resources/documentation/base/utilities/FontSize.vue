...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="font-sizes" class="anchor fw-bolder mb-5">
      <a href="#font-sizes" />
      Font Sizes
    </h1>
    <!-- end::Heading -->
    ...
    <div class="py-5">
      ...
      <a href="https://getbootstrap.com/docs/5.0/utilities/text/#font-size" class="fw-bold">Bootstrap Font Size
        Classes</a>&nbsp; to provide additonal spacing options by overidding the default
    ...
    <!-- begin::Code -->
    <div class="py-5">
      <CodeHighlighter :field-height="200" lang="scss">
        {{
          `$font-sizes: (
