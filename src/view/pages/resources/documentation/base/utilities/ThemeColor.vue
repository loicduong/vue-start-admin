...
<template>
  ...
  <div class="pb-10">
    ...
    <div class="py-5">
      ...
      <a href="https://getbootstrap.com/docs/5.0/customize/color/" class="fw-bold">Bootstrap Colors</a>&nbsp; system
      with extra variants to cover its own design system build on
    ...
    <!-- begin::Code -->
    <CodeHighlighter lang="scss" :field-height="300">
      {{
        `// Theme colors
      $theme-colors: (
