...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="width-and-height" class="anchor fw-bolder mb-5">
    ...
    <div class="py-5">
      ...
      <ul class="pt-3">
        <li class="py-2">
          <code>h</code> - for classes that set height
        </li>
        <li class="py-2">
          <code>mh</code> - for classes that set max height
        </li>
        <li class="py-2">
          <code>min-h</code> - for classes that set min height
        </li>
        <li class="py-2">
          <code>w</code> - for classes that set width
        </li>
        <li class="py-2">
          <code>mw</code> - for classes that set max width
        </li>
        <li class="py-2">
    ...
    <div class="py-5">
      <div class="rounded border p-10">
        ...
        <div class="separator border-solid mt-10 mb-12" />
