...
<template>
  ...
  <div class="card">
    ...
    <div class="card-body p-10 p-lg-15">
      ...
      <div class="pb-10">
        <!-- begin::Heading -->
        <h1 id="text-colors" class="anchor fw-bolder mb-3">
          <a href="#text-colors" />
          Text Colors
        </h1>
        <!-- end::Heading -->
      ...
      <div class="py-10">
        <!-- begin::Heading -->
        <h1 id="light-colors" class="anchor fw-bolder mb-3">
          <a href="#light-colors" />
          Light Colors
        </h1>
        <!-- end::Heading -->
        ...
        <div class="py-5">
          <div class="rounded border p-10">
            <template v-for="(item, i) in colors.lightColors" :key="i">
              <p :class="`text-light-${item} bg-${item}`" class="p-3 fw-bold fw-6">
                .text-light-{{ item }}
              </p>
            </template>
          </div>
      ...
      <div class="pt-10">
        <!-- begin::Heading -->
        <h1 id="inverse-colors" class="anchor fw-bolder mb-3">
        ...
        <div class="py-5">
          <div class="rounded border p-10">
            <template v-for="(item, i) in colors.inverseColors" :key="i">
              <p :class="`text-inverse-${item} bg-${item}`" class="p-3 fw-bold fw-6">
                .text-inverse-{{ item }}
              </p>
            </template>
          </div>
      ...
      <div class="pt-10">
        <!-- begin::Heading -->
        <h1 id="inverse-hover-colors" class="anchor fw-bolder mb-3">
        ...
        <div class="py-5">
          <div class="rounded border p-10">
            <template v-for="(item, i) in colors.inverseColors" :key="i">
              <p :class="`text-hover-inverse-${item} bg-hover-${item}`" class="p-3 fw-bold fw-6">
