  ...
  <div class="py-10">
    ...
    <div class="py-5">
      <div class="rounded border p-10">
        <!-- begin::Accordion -->
        <div id="kt_accordion_1" class="accordion">
          <div class="accordion-item">
            <h2 id="kt_accordion_1_header_1" class="accordion-header">
              <button
          ...
          <div class="accordion-item">
            <h2 id="kt_accordion_1_header_2" class="accordion-header">
              <button
          ...
          <div class="accordion-item">
            <h2 id="kt_accordion_1_header_3" class="accordion-header">
              <button
                class="accordion-button fs-4 fw-bold collapsed"
                type="button"
                data-bs-toggle="collapse"
