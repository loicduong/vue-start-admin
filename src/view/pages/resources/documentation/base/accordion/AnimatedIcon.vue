...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="animated-icon" class="anchor fw-bolder mb-5">
    ...
    <div class="py-5">
      <div class="rounded border p-10">
        <!-- begin::Accordion -->
        <div id="kt_accordion_2" class="accordion accordion-icon-toggle">
          <!-- begin::Item -->
          <div class="mb-5">
            <!-- begin::Header -->
            ...
            <!-- begin::Body -->
            <div id="kt_accordion_2_item_1" class="fs-5 collapse show ps-10" data-bs-parent="#kt_accordion_2">
          ...
          <div class="mb-5">
            ...
            <div
              ...
              data-bs-target="#kt_accordion_2_item_2_2"
            >
              <span class="accordion-icon">
                <span class="svg-icon svg-icon-4">
                  <InlineSvg src="/media/icons/duotone/Navigation/Right-2.svg" />
            ...
            <!-- begin::Body -->
            <div id="kt_accordion_2_item_2_2" class="collapse fs-5 ps-10" data-bs-parent="#kt_accordion_2">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been the industry's standard dummy text
              ever since the 1500s, when an unknown printer took a galley of
              type and scrambled it to make a type specimen book. It has
          ...
          <div class="mb-5">
            ...
            <div
              class="accordion-header py-3 d-flex collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#kt_accordion_2_item_3_3"
            >
              <span class="accordion-icon">
                <span class="svg-icon svg-icon-4">
                  <InlineSvg src="/media/icons/duotone/Navigation/Right-2.svg" />
            ...
            <!-- begin::Body -->
            <div id="kt_accordion_2_item_3_3" class="collapse fs-5 ps-10" data-bs-parent="#kt_accordion_2">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been the industry's standard dummy text
              ever since the 1500s, when an unknown printer took a galley of
              type and scrambled it to make a type specimen book. It has
    ...
    <div class="py-5">
      <CodeHighlighter :field-height="400" lang="html">
        {{ `<!--begin::Accordion-->
        <div class="accordion accordion-icon-toggle" id="kt_accordion_2_2">
          <!--begin::Item-->
          <div class="mb-5">
            <!--begin::Header-->
            <div class="accordion-header py-3 d-flex" data-bs-toggle="collapse" data-bs-target="#kt_accordion_2_item_1">
          ...
          <div class="mb-5">
            ...
            <!--begin::Body-->
            <div id="kt_accordion_2_item_2" class="collapse fs-5 ps-10" data-bs-parent="#kt_accordion_2">
              ...
            </div>
            <!--end::Body-->
          </div>
          ...
          <div class="mb-5">
            ...
            <!--begin::Body-->
            <div id="kt_accordion_2_item_3" class="collapse fs-5 ps-10" data-bs-parent="#kt_accordion_2">
              ...
            </div>
            <!--end::Body-->
          </div>
