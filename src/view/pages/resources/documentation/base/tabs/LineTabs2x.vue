...
<template>
  ...
  <div class="py-10">
    <!-- begin::Heading -->
    <h1 id="line-tabs-2x" class="anchor fw-bolder mb-5">
      <a href="#line-tabs-2x" />
      Line Tabs 2x
    </h1>
    <!-- end::Heading -->
    ...
    <!-- begin::Block -->
    <div class="py-5">
      Add <code>.nav-line-tabs-2x</code> class to us a line tab with 2px border
      width:
    </div>
    <!-- end::Block -->
    ...
    <div class="py-5">
      <div class="rounded border p-10">
        ...
        <div id="myTabContent" class="tab-content">
          <div id="kt_tab_pane_4" class="tab-pane fade show active" role="tabpanel">
