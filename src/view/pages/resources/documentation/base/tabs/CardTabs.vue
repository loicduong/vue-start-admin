...
<template>
  ...
  <div class="pt-10">
    <!-- begin::Heading -->
    <h1 id="card-tabs" class="anchor fw-bolder mb-5">
      <a href="#card-tabs" />
      Card Tabs
    </h1>
    <!-- end::Heading -->
        ...
        <div class="card shadow">
          ...
          <div class="card-body">
            <div id="myTabContent" class="tab-content">
              ...
              <div id="kt_tab_pane_8" class="tab-pane fade" role="tabpanel">
              ...
              <div id="kt_tab_pane_9" class="tab-pane fade" role="tabpanel">
