...
function handleStep(validate: any, stepper: any) {
...
<template>
  ...
  <div id="kt_modal_create_app" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-1000px">
      <div class="modal-content">
        <div class="container px-19 py-16">
          <!-- begin::Stepper -->
          <div
          ...
          >
            ...
            <div class="d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px">
              <!-- begin::Nav -->
              <div class="stepper-nav d-flex flex-column  pt-15">
                <!-- begin::Step 1 -->
              ...
              >
                ...
                <div class="pb-5 current" data-kt-stepper-element="content">
                  <div class="w-100">
                    ...
                    <div class="fv-row">
                      <!-- begin:Option -->
                      <label class="d-flex align-items-center justify-content-between mb-6 cursor-pointer">
                        <span class="d-flex align-items-center me-2">
                          <span class="symbol symbol-50px me-6">
                            <span class="symbol-label bg-light-primary">
                              <span class="svg-icon svg-icon-1 svg-icon-primary">
                                <InlineSvg src="/media/icons/duotone/Home/Globe.svg" />
                              </span>
                            </span>
                          </span>
                          ...
                          <span class="symbol symbol-50px me-6">
                            <span class="symbol-label bg-light-success">
                              <span class="svg-icon svg-icon-1 svg-icon-success">
                                <InlineSvg src="/media/icons/duotone/Devices/Watch1.svg" />
                              </span>
                            </span>
                          </span>
                ...
                <div class="pb-5" data-kt-stepper-element="content">
                  <div class="w-100">
                    ...
                    <div class="fv-row">
                      ...
                      <!-- begin:Option -->
                      <label class="d-flex align-items-center justify-content-between cursor-pointer mb-6">
                        <span class="d-flex align-items-center me-2">
                          <span class="symbol symbol-50px me-6">
                    ...
                    <div class="fv-row">
                      ...
                      <label class="d-flex align-items-center justify-content-between cursor-pointer mb-6">
                        <span class="d-flex align-items-center me-2">
                          <span class="symbol symbol-50px me-6">
                            <span class="symbol-label bg-light-primary  ">
                              <i class="fab fa-linux text-primary fs-2x" />
                            </span>
                          </span>
                      ...
                      <label class="d-flex align-items-center justify-content-between cursor-pointer mb-6">
                        <span class="d-flex align-items-center me-2">
                          <span class="symbol symbol-50px me-6">
                            <span class="symbol-label bg-light-warning">
                              <i class="fab fa-aws text-warning fs-2x" />
                            </span>
                          </span>
                      ...
                      <label class="d-flex align-items-center justify-content-between cursor-pointer mb-6">
                        <span class="d-flex align-items-center me-2">
                          <span class="symbol symbol-50px me-6">
                            <span class="symbol-label bg-light-success  ">
                              <i class="fab fa-google text-success fs-2x" />
                            </span>
                          </span>
                  ...
                  <div class="mr-2">
                    ...
                    >
                      <span class="svg-icon svg-icon-3 me-1">
                        <InlineSvg src="/media/icons/duotone/Navigation/Left-2.svg" />
                      </span>
                      Previous
                    </button>
                  </div>
                  <div>
                    ...
                    >
                      ...
                      <span class="svg-icon svg-icon-3 ms-2">
                        <InlineSvg src="/media/icons/duotone/Navigation/Right-2.svg" />
                      </span>
                    </button>
