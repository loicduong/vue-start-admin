...
<template>
  ...
  >
    ...
    >
      <div class="symbol symbol-45px mx-5 py-5">
        <span class="symbol-label bg-primary align-items-end">
          <img alt="Logo" src="/media/svg/avatars/001-boy.svg" class="mh-35px">
        </span>
      </div>
      <div class="">
    ...
    <div class="row row-cols-2 g-0">
      ...
      <RouterLink to="/settings" class="col border-bottom text-center py-10 btn btn-active-color-primary rounded-0">
        <span class="svg-icon svg-icon-3x me-n1">
          <InlineSvg src="/media/icons/duotone/General/Settings-1.svg" />
        </span>
        <span class="fw-bolder fs-6 d-block pt-3">
          Settings
        </span>
      ...
      <RouterLink to="/pricing" class="col text-center border-end py-10 btn btn-active-color-primary rounded-0">
        <span class="svg-icon svg-icon-3x me-n1">
          <InlineSvg src="/media/icons/duotone/Shopping/Euro.svg" />
        </span>
        <span class="fw-bolder fs-6 d-block pt-3">
          Subscriptions
        </span>
      ...
      <a href="#" class="col text-center py-10 btn btn-active-color-primary rounded-0">
        <span class="svg-icon svg-icon-3x me-n1">
          <InlineSvg src="/media/icons/duotone/Navigation/Sign-out.svg" />
        </span>
        <span class="fw-bolder fs-6 d-block pt-3">
          Sign Out
        </span>
