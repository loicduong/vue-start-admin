...
import MessageIn from '@/view/content/extras/messenger-parts/MessageIn.vue'
import MessageOut from '@/view/content/extras/messenger-parts/MessageOut.vue'
    ...
    <div id="kt_drawer_chat_messenger" class="card w-100">
      ...
      <div id="kt_drawer_chat_messenger_header" class="card-header pe-5">
        ...
        <div class="card-toolbar">
          ...
          <!-- begin::Close -->
          <div id="kt_drawer_chat_close" class="btn btn-sm btn-icon btn-active-icon-primary">
            <span class="svg-icon svg-icon-2x">
              <InlineSvg src="/media/icons/duotone/Interface/Close-Square.svg" />
            </span>
          </div>
          <!-- end::Close -->
        </div>
