  ...
  <div class="card card-custom mb-5 mb-xxl-8">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title align-items-start flex-column">
        ...
        <span class="text-muted mt-2 fw-bold fs-5">More than 400+ new members</span>
      </h3>
        ...
        <div id="kt_tab_pane_1_1" class="tab-pane fade show active" role="tabpanel" aria-labelledby="kt_tab_pane_1_1">
          <div class="d-flex flex-column">
            <div class="flex-grow-1">
              <Apexchart :options="chartOptions" :series="statsToShow" height="150" type="area" />
            </div>
            ...
            <div class="mt-5 px-9">
              <template v-for="(item, i) in dataToShow" :key="i">
                ...
                >
                  ...
                  <!-- begin::Label -->
                  <div class="bg-light rounded fw-bolder text-gray-600 py-2 px-3">
                    {{ item.profit }}
                  </div>
                  <!-- end::Label -->
                </div>
