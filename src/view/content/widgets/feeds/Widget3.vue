  ...
  <div class="card card-custom mb-5 mb-xxl-8">
    ...
    <div class="card-body pb-0">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="symbol symbol-45px me-5">
          <span class="symbol-label bg-light align-items-end">
            <img alt="Logo" src="/media/svg/avatars/047-girl-25.svg" class="mh-40px">
          </span>
        </div>
        <!-- end::Symbol -->
        ...
        <div class="d-flex flex-column flex-grow-1">
          ...
          <span class="text-muted fw-bold">Yesterday at 5:06 PM</span>
        </div>
        <!-- end::Info -->
        ...
        <div class="dropdown dropdown-inline">
          ...
          >
            <span class="svg-icon svg-icon-4">
              <InlineSvg src="/media/icons/duotone/Text/Dots.svg" />
            </span>
          </button>
      ...
      <div class="pt-4">
        <!-- begin::Image -->
        <div
          class="bgi-no-repeat bgi-size-cover rounded min-h-250px"
          style="background-image:url('media/stock/900x600/3.jpg');"
        />
        <!-- end::Image -->

        <!-- begin::Text -->
        <p class="text-gray-800 fs-6 fw-normal pt-5 mb-2">
