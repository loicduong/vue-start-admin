    ...
    <div class="card-body">
      ...
      <div class="d-flex bg-light-primary card-rounded flex-grow-1">
        ...
        <div class="py-10 ps-7">
          ...
          <a
            href="#"
            class="btn btn-primary btn-sm fw-bolder fs-6 ps-4 mt-6"
            data-bs-toggle="modal"
            data-bs-target="#kt_modal_create_app"
          >
            Boost
            <span class="svg-icon svg-icon-3 me-0">
              <InlineSvg src="/media/icons/duotone/Navigation/Up-right.svg" />
            </span>
          </a>
        </div>
        <!-- end::Section -->
        ...
        <div
          ...
          style="background-image:url('media/misc/illustration-1.png')"
        />
        <!-- end::Pic -->
      </div>
      <!-- end::Top -->
      ...
      <div class="pt-9">
        ...
        <div class="row">
          ...
          <div class="col mb-5">
            ...
            >
              <span class="svg-icon svg-icon-2x svg-icon-gray-800 ms-n1">
                <InlineSvg src="/media/icons/duotone/General/Clipboard.svg" />
              </span>
              <span class="text-gray-800 fw-bolder fs-6 d-block pt-6">
                Read Docs
              </span>
        ...
        <div class="row">
          <div class="col me-n2 mb-5">
            ...
            >
              <span class="svg-icon svg-icon-2x svg-icon-gray-800 ms-n1">
                <InlineSvg src="/media/icons/duotone/Files/File-plus.svg" />
              </span>
              <span class="text-gray-800 fw-bolder fs-6 d-block pt-6">
                MRC 22 XML
              </span>
        ...
        <div class="row">
          <div class="col mb-5 me-n2">
            ...
            >
              <span class="svg-icon svg-icon-2x svg-icon-gray-800 ms-n1">
                <InlineSvg src="/media/icons/duotone/Files/Compiled-file.svg" />
              </span>
              <span class="text-gray-800 fw-bolder fs-6 d-block pt-6">
                Check List
              </span>
          ...
          <div class="col mb-5">
            ...
            >
              <span class="svg-icon svg-icon-2x svg-icon-gray-800 ms-n1">
                <InlineSvg src="/media/icons/duotone/Files/File-cloud.svg" />
              </span>
              <span class="text-gray-800 fw-bolder fs-6 d-block pt-6">
                Reports
              </span>
