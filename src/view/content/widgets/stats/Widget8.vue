<template>
  <div class="card card-custom mb-5 mb-xxl-8">
    ...
    <div class="card-body">
      ...
      >
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap">
          <!-- begin::Label -->
          <span class="fs-5 text-muted fw-bolder pr-2">Projects</span>
          <!-- end::Label -->

          <!-- begin::Carousel Indicators -->
          <ol class="p-0 m-0 carousel-indicators carousel-indicators-dots">
            <li data-bs-target="#kt_stats_widget_8_carousel" data-bs-slide-to="0" class="ms-1 active" />
            <li data-bs-target="#kt_stats_widget_8_carousel" data-bs-slide-to="1" class="ml-1" />
            <li data-bs-target="#kt_stats_widget_8_carousel" data-bs-slide-to="2" class="ml-1" />
          </ol>
    ...
    <div class="card-footer border-0 pt-0 pb-10">
      <!-- begin::Text -->
      <div class="d-flex text-muted fw-bold fs-5 pb-4">
