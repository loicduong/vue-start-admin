      ...
      <div class="card-toolbar">
        ...
        >
          <span class="svg-icon svg-icon-1">
            <InlineSvg src="/media/icons/duotone/Layout/Layout-4-blocks-2.svg" />
          </span>
        </button>
        <Dropdown4 />
        <!-- end::Dropdown -->
    ...
    <div class="card-body pt-0">
      <div class="d-flex flex-wrap flex-xxl-nowrap justify-content-center justify-content-md-start pt-4">
          ...
          <ul class="nav flex-column nav-pills nav-pills-custom">
            <li class="nav-item mb-3">
              ...
              >
                <div class="nav-icon me-3">
                  <img alt="" src="/media/svg/logo/gray/aven.svg" class="default">
            ...
            <li class="nav-item mb-3">
              <a
                ...
                class="nav-link w-225px h-70px"
                data-bs-toggle="pill"
                href="#kt_stats_widget_2_tab_2_content"
              >
                <div class="nav-icon me-3">
                  <img alt="" src="/media/svg/logo/gray/tower.svg" class="default">
            ...
            <li class="nav-item mb-3">
              ...
              >
                <div class="nav-icon me-3">
                  <img alt="" src="/media/svg/logo/gray/fox-hub-2.svg" class="default">
            ...
            <li class="nav-item mb-5">
              ...
              >
                <div class="nav-icon me-3">
                  <img alt="" src="/media/svg/logo/gray/kanba.svg" class="default">
        ...
        <div class="tab-content flex-grow-1">
          <!-- begin::Tab Pane 1 -->
          <div id="kt_stats_widget_2_tab_1_content" class="tab-pane fade show active">
            <!-- begin::Content -->
            ...
            <!-- begin::Chart -->
            <Apexchart :options="chartOptions" :series="series1" height="250" type="bar" />
            <!-- end::Chart -->
          </div>
          <!-- end::Tab Pane 1 -->

          <!-- begin::Tab Pane 2 -->
          <div id="kt_stats_widget_2_tab_2_content" class="tab-pane fade">
            <!-- begin::Content -->
            <div class="d-flex justify-content-center mb-10">
              <!-- begin::Item -->
              <div class="px-10">
            ...
            <!-- begin::Chart -->
            <Apexchart :options="chartOptions" :series="series2" height="250" type="bar" />
            <!-- end::Chart -->
          </div>
          <!-- end::Tab Pane 2 -->

          <!-- begin::Tab Pane 3 -->
          <div id="kt_stats_widget_2_tab_3_content" class="tab-pane fade">
            <!-- begin::Content -->
            <div class="d-flex justify-content-center mb-10">
              <!-- begin::Item -->
              <div class="px-10">
            ...
            <!-- begin::Chart -->
            <Apexchart :options="chartOptions" :series="series3" height="250" type="bar" />
            <!-- end::Chart -->
          </div>
          <!-- end::Tab Pane 3 -->

          <!-- begin::Tab Pane 4 -->
          <div id="kt_stats_widget_2_tab_4_content" class="tab-pane fade">
            <!-- begin::Content -->
            <div class="d-flex justify-content-center mb-10">
              <!-- begin::Item -->
              <div class="px-10">
            ...
            <!-- begin::Chart -->
            <Apexchart :options="chartOptions" :series="series4" height="250" type="bar" />
            <!-- end::Chart -->
          </div>
          <!-- end::Tab Pane 4 -->
        </div>
